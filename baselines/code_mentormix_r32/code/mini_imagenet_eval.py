...
import mini_imagenet_data_provider
import resnet_model
...
flags.DEFINE_string('split_name', 'clean_validation', """Either 'clean_validation'.""")
...
def eval_resnet():
  ...
  with g.as_default():
    ...
    (images, one_hot_labels, num_samples,
     num_of_classes) = mini_imagenet_data_provider.provide_resnet_data(
         FLAGS.dataset_name,
         FLAGS.split_name,
         FLAGS.batch_size,
    ...
    for name, value in names_to_values.items():
      slim.summaries.add_scalar_summary(
          value, name, prefix='test', print_summary=True)
